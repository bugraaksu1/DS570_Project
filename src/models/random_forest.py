...
def run_advanced_training_pipeline(raw_data):
    #  Split data chronologically using our custom source function
    X_train, X_test, y_train, y_test = prepare_and_split_data(raw_data, target_col='Signal_Y')

    #  Select only signal features (exclude TimeStamp from training)
    ...
    #  Dedicated hyperparameters matching your Colab experiment
    ...
    # Persist the model artifact for dashboard usage
